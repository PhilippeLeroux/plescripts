...
exec_cmd "sed -i \"s!DNS_NAME!$dns_hostname!\" $shared_directory/createvm.bat"
LN

info "Mise à jour de create_mydns_vm.bat :"
exec_cmd "sed -i \"s!DNS_NAME!$dns_hostname!\" $shared_directory/create_K2_vm.bat"
LN
exec_cmd "sed -i \"s!VM_MEMORY_MB_FOR_DNS!$vm_memory_mb_for_dns!\" $shared_directory/create_K2_vm.bat"
LN

...
2 VMs sont nécessaires pour commencer :
 ...
 - K2 qui est le serveur d'infrastructure est remplie de multiples fonctions :
   ...
   - Gateway : Les serveurs de base de données passent par K2 pour aller sur internet.
